...
{
    /// <inheritdoc />
    public partial class AddOrderingEngine : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerPhoneNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_RestaurantId_CustomerId_Status",
                table: "Carts",
                columns: new[] { "RestaurantId", "CustomerId", "Status" });
